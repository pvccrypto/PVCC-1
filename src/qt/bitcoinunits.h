...
/** PVCC unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PVCCUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PVCCUnits(QObject *parent);
...
typedef PVCCUnits::Unit PVCCUnit;
