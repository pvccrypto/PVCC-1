...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
  ...
  Q_PROPERTY(bool rangePVCCersed READ rangePVCCersed WRITE setRangePVCCersed)
...
public:
  ...
  */
  ...
  bool rangePVCCersed() const { return mRangePVCCersed; }
  ...
  void setRangePVCCersed(bool reversed);
