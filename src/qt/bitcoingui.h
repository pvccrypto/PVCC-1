...
/**
  PVCC GUI main class. This class represents the main window of the PVCC UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PVCCGUI : public QMainWindow
{
    Q_OBJECT

public:
    explicit PVCCGUI(QWidget *parent = 0);
    ~PVCCGUI();
