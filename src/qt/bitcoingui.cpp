...
PVCCGUI::PVCCGUI(QWidget *parent):
    QMainWindow(parent),
    clientModel(0),
    walletModel(0),
    toolbar(0),
    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("PVCC") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    setObjectName("PVCC");
    setStyleSheet("#PVCC { background-image: url(:/images/background_light); }");//background-color: #e6e6e6; color: #333333;
...
void PVCCGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PVCC address"));
    ...
    aboutAction = new QAction(QIcon(fUseDarkTheme ? ":/icons/dark/bitcoin-dark" : ":/icons/bitcoin"), tr("&About PVCC"), this);
    aboutAction->setToolTip(tr("Show information about PVCC"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PVCC"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit PVCC.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for PVCC"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit PVCC.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for PVCC (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where PVCC data is stored"));
...
void PVCCGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("PVCC client") + QString(" ") + tr("[testnet]"));
...
void PVCCGUI::setWalletModel(WalletModel *walletModel)
{
...
void PVCCGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PVCC client"));
...
#ifndef Q_OS_MAC
void PVCCGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void PVCCGUI::aboutQtExt_Internal()
{
    aboutQtAction->triggered();
}

void PVCCGUI::aboutQtExt_Static()
{
    guiref->aboutQtExt_Internal();
}

void PVCCGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    //labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PVCC network", "", count));
}

void PVCCGUI::setNumBlocks(int count)
{
    QString tooltip;
...
void PVCCGUI::message(const QString &title, const QString &message, bool modal, unsigned int style)
{
    QString strTitle = tr("PVCC") + " - ";
...
void PVCCGUI::error(const QString &title, const QString &message, bool modal)
{
...
void PVCCGUI::changeEvent(QEvent *e)
{
...
void PVCCGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void PVCCGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;
    ...
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(PVCCUnits::formatWithUnit(clientModel->getOptionsModel()->getDisplayUnit(), nFeeRequired));
...
void PVCCGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
    ...
    notificator->notify(Notificator::Information,
                        (amount)<0 ? tr("Sent transaction") :
                          ...
                          tr("Date: %1\n"
                             ...
                             "Address: %4\n")
                          .arg(date)
                          .arg(PVCCUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                          .arg(type)
                          .arg(address), icon);
}

void PVCCGUI::clearWidgets()
{
...
void PVCCGUI::gotoMasternodeManagerPage()
{
    ...
    setStyleSheet("#PVCC { background-image: url(:/images/background_light_alt); }");
}

void PVCCGUI::gotoBlockBrowser()
{
...
void PVCCGUI::gotoOverviewPage()
{
    ...
    setStyleSheet("#PVCC { background-image: url(:/images/background_light); }");
}

void PVCCGUI::gotoHistoryPage()
{
...
void PVCCGUI::gotoHistoryPage_static()
{
    guiref->gotoHistoryPage();
}

void PVCCGUI::gotoAddressBookPage()
{
...
void PVCCGUI::gotoReceiveCoinsPage()
{
...
void PVCCGUI::gotoSendCoinsPage()
{
...
void PVCCGUI::gotoSignMessageTab(QString addr)
{
...
void PVCCGUI::gotoVerifyMessageTab(QString addr)
{
...
void PVCCGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void PVCCGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PVCC address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void PVCCGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void PVCCGUI::setWalletUnlockStakingOnly()
{
...
void PVCCGUI::setEncryptionStatus(int status)
{
...
void PVCCGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void PVCCGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void PVCCGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
/*void PVCCGUI::updateStakingIcon()
{
    updateWeight();
...
void PVCCGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

/*void PVCCGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0)
    {
